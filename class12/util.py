...
# Define the geometry and biophysics to be used for the Ball and Stick Neurons
cell_geometry = namedtuple('cell_geometry', 'soma_d soma_l dend_d dend_l dend_nseg')
cell_biophysics = namedtuple('cell_biophysics', 'Ra Cm gna_max gk_max gl_max e_leak g_pas e_pas')
...
# in NEURON
def connectNetStim(stim, synapse, delay, weight, section = None):
    netcon = h.NetCon(stim, synapse, sec = section)
    netcon.delay = delay
