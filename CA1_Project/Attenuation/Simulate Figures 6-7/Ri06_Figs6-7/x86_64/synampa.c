...
#define nrn_init _nrn_init__synampa
#define _nrn_initial _nrn_initial__synampa
#define nrn_cur _nrn_cur__synampa
#define _nrn_current _nrn_current__synampa
#define nrn_jacob _nrn_jacob__synampa
#define nrn_state _nrn_state__synampa
#define _net_receive _net_receive__synampa 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 synampa /home/yaakov/NEUR634/CA1_Project/Attenuation/Simulate Figures 3-5/Ri04_Figs3-5/x86_64/synampa.mod\n");
...
double cond ( _threadargsprotocomma_ double _lx ) {
 ...
 _ztpeak = tau0 * tau1 * log ( tau0 / tau1 ) / ( tau0 - tau1 ) ;
   _zadjust = 1.0 / ( ( 1.0 - exp ( - _ztpeak / tau0 ) ) - ( 1.0 - exp ( - _ztpeak / tau1 ) ) ) ;
   _zamp = _zadjust * gmax ;
   if ( _lx < onset ) {
     _lcond = 0.0 ;
     }
   else {
     _za [ 0 ] = 1.0 - exp ( - ( _lx - onset ) / tau0 ) ;
     _za [ 1 ] = 1.0 - exp ( - ( _lx - onset ) / tau1 ) ;
