...
# Define the parameters used to create the soma and dendrite compartments, and the pulse
...
# Create the soma and dendrite and connect them to each other
...
# Define dictionaries for the excitatory channel, and the pre-synaptic neurons
...
# Create a table to store the output time of the spikes
